...
class CustomTitleBar(QWidget):
    def __init__(self, parent):
        ...
        layout = QHBoxLayout(self); layout.setContentsMargins(5, 0, 0, 0); layout.setSpacing(10)
        
        btn_size = 30
        self.toggle_button = QPushButton("❮"); self.toggle_button.setObjectName("windowButton"); self.toggle_button.setFixedSize(btn_size, btn_size)
        self.title = QLabel("Chorus.Ai"); self.title.setObjectName("windowTitle")
        
        layout.addWidget(self.toggle_button); layout.addWidget(self.title); layout.addStretch()
